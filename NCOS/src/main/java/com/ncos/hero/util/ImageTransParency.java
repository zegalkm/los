...
//      }
      ...
      final String inputFileName = "/Users/Taengoo/Desktop/atk.bmp";
      final int decimalPosition = inputFileName.lastIndexOf(".");
      final String outputFileName = "/Users/Taengoo/Desktop/atk.copy.png";
...
//      final int color = source.getRGB(0, 0);
      System.out.println("RGB : "+new Color(151,151,255,255).getRGB());//순서대로 R,G,B,Alpha값이다. 0이 투명, 255가 불투명.
      final Image imageWithTransparency = makeColorTransparent(source, new Color(151,151,255,255));
...
//         public int markerRGB = 0xff9797ff;
         public int markerRGB = color.getRGB();
         
//         public int markerRGB = 0x00A9ACF9;
